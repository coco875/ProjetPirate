...
# Script pour lancer l'interface console du Jeu des Pirates

echo "Lancement de l'interface console du Jeu des Pirates..."
...
if [ -d "lib" ]; then
    ...
    java -XX:+ShowCodeDetailsInExceptionMessages --module-path bin:lib -m ProjetPirate/ProjetPirate.MainUI console
else
    ...
    java -XX:+ShowCodeDetailsInExceptionMessages --module-path bin -m ProjetPirate/ProjetPirate.MainUI console
fi
